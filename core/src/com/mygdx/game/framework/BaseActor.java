...
/**
 * Расширяет функционал класса Actor LibGDX.
...
public class BaseActor extends Group
{
    ...
    public BaseActor(float x, float y, Stage s)
    {
        ...
        // установка позиции и добавление в сцену данного объекта
        setPosition(x,y);
        s.addActor(this);
    ...
    /**
     * Если объект выходит за границы игрового мира, данный метод
     * возвращет удерживает его внутри
     */
    ...
    /**
     *  Выравнивает центр объекта по заданным координатам
    ...
    public Animation<TextureRegion> loadAnimationFromFiles(String[] fileNames, float frameDuration, boolean loop)
    {
        ...
        Array<TextureRegion> textureArray = new Array<TextureRegion>(true, fileCount, TextureRegion.class);
     ...
     *  @param theClass name of a class that extends the BaseActor class
    ...
    {
        return getList(stage, theClass).size();
    }
    ...
    public void draw(Batch batch, float parentAlpha)
    {
        ...
        if ( animation != null && isVisible() ) {
            ...
            //обнуление значения elapsedTime
